...
from dimapp.views import Home, CourseHome, CourseLectures, CourseAssignments, CourseLabs, Grades, ViewAnnouncement, AddCourse, AddCourseSuccess, ToggleDarkMode
...
urlpatterns = [
    ...
    path('dimspace/toggledarkmode', ToggleDarkMode.as_view())
]
